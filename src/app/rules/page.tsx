...
const PLAN_RULES = {
  '1-step': {
    evaluation: [
      ...
      { text: "If any single open trade loses more than 1% of your starting balance at any moment, that trade will be automatically closed for you", warning: true },
      { text: "You cannot double your trade size after a loss to recover - this is forbidden", check: false },
    ],
    funded: [
  ...
  'instant': {
    active: [
      ...
      { text: "Your account will automatically close after 30 days from the day you bought it, even if you have not passed yet", warning: true },
    ],
    prohibited: [
      { text: "Wait at least 3 minutes between trades and hold for 2+ minutes", warning: true },
      { text: "If any single open trade loses more than 1% of your account balance at any time, that trade will be automatically closed for you", warning: true },
      { text: "Do not lose more than 3% of your starting balance in a single day", warning: true },
  ...
  'instant-pro': {
    active: [
      ...
      { text: "A trading day only counts towards your payout if you completed at least 3 trades that day", check: true },
    ...
    prohibited: [
      ...
      { text: "If any single open trade loses more than 1% of your starting balance (e.g. $100 on a $10,000 account) at any moment, that trade will be automatically closed for you", warning: true },
      { text: "You cannot double your trade size after a loss to recover - this is forbidden", check: false },
      { text: "Try to close all trades before the market closes on Friday evening", warning: true },
    ]
  }
